...
def page1():
    ...
    st.markdown(
        '<p class="custom-text">You are invited to participate in a pilot study designed to explore perceptions of contrasted linguistic style in Large Language Model(LLM)-generated texts. Before you decide to participate, it is important that you understand why this study is being conducted and what your participation involves. Please read the following information carefully.</p>',
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <p class="custom-text">
        The risks associated with this pilot study are minimal and comparable to those encountered during routine computer-based tasks, such as mild fatigue or boredom. Texts included in this study are generated by LLMs, and may occasionally include words that could be sensitive or uncomfortable, though no extreme or offensive material is intentionally included. The texts included in this study do not necessarily reflect researchers' views.
        </p>
        <p class="custom-text">
        The primary benefit of participation is contributing to the understanding in the gendered style contrast in LLM-generated text pairs.
        </p>
        """,
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <p class="custom-text">
        Your participation will take an estimated 15 minutes. The time required may vary on an individual basis.
        </p>
        """,
        unsafe_allow_html=True,
    )
...
def page3():
    ...
    st.markdown(
        """
        <p class="custom-text">
        In this study, you will compare <strong>10</strong> pairs of short texts. Your main task is to judge how strongly the two texts differ along a feminine–masculine stylistic dimension based on your intuitions, while also considering how similar they are in meaning and in fluency or grammatical acceptability. Please base your judgments on <strong>how the texts are generated</strong>, such as tone, wording, and sentence structure, rather than what the texts are about and the length of the texts alone.
        </p>
        """,
        unsafe_allow_html=True,
    )
    ...
    if st.button("Submit", key="page8_submit", disabled=st.session_state.get("submitted", False)):
        ...
        if user_id in st.session_state.get("submitted_users", set()):
            ...
            try:
                ...
                st.success("Thank you for your submission! You completion code is C10BORY8")
